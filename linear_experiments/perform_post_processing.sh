...
# plotting
# --------
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_01
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_02

bash plot_all_errors.sh plot_energy_errors_energy_flattening_off.py results/experiment_03
bash plot_all_errors.sh plot_energy_errors_energy_flattening_off.py results/experiment_04

bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_09
bash plot_all_errors.sh plot_energy_errors_energy_flattening_off.py results/experiment_10

bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_12
bash plot_all_errors.sh plot_energy_errors_energy_flattening_off.py results/experiment_13

# Combined Stopping Criteria
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_14
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_15
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_16
bash plot_all_errors.sh plot_energy_errors_relative_energy_reduction.py results/experiment_17