...
## Experiment 01 (Problem 1 with relative energy reduction)
...
## Experiment 02 (Problem 2 with relative energy reduction)
...
## Experiment 09 (Problem 4 with relative energy reduction and preconditioner $P=\text{diag}(\text{lhs})^{-1}$)
...
## Experiment 12 (Problem 5 with relative energy reduction)
