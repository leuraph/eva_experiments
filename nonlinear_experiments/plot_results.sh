...
python plot_energy_norm_errors_combined.py \
    --problem 4 \
    --default-path results/problem-4_default_theta-0.5_eta-1.0_miniter-10_gtol-1e-08\
    --arioli-path results/problem-4_relative-energy-decay_theta-0.5_eta-1.0_fudge-0.1_miniter-10_tau-1.01_initial_delay-10_delay_increase-5\
    --tail-off-path results/problem-4_energy-tail-off_theta-0.5_eta-1.0_fudge-0.01_miniter-10_batchsize-5