"""
Given a pre-computed graded mesh,
this script computes a reference solution
\tilde{u} thereon using the solver
as described in https://arxiv.org/abs/2504.11292.
"""
