"""
Given a reference (graded) mesh
and reference solution \tilde{u} thereon,
this script computes the energy E(\tilde{u})
"""
import argparse
...
from p1afempy.solvers import get_right_hand_side, \
    integrate_composition_nonlinear_with_fem, get_general_stiffness_matrix
